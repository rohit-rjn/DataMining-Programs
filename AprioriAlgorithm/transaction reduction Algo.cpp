/**Implementation of Apriori algorithm with transaction reduction extension**/

/**
    Author: Rohit Ranjan
    B.Tech CSE(2011-15), National Institute of Technology, Warangal
**/
...
void remove_transaction(int k)
{
    ...
    for(int j=1; j<=t; j++)
    {
        ...
        if(include_transaction[j] == true)
        {
            ...
            if(c == 0)
            {
                include_transaction[j] = false;
                cout<<"\nTransaction "<<j<<" has been removed from further scans\n";
            }
        }
